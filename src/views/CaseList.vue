<template>
  <section class="pt-4 lg:pt-12">
    <div
      class=" px-2 md:px-10 xl:px-16 mb-2 md:mb-16 mx-auto w-full py-6 lg:py-1"
    >
...
export default {
  ...
  methods: {
    getCases() {
      ...
      axios
        .get(`${window.host}/api/cases?page=${this.page}`)
        .then(response => {
          ...
          if (this.cases.length < 1) this.message = "No cases recorded yet!";
    ...
    search() {
      ...
      axios
        ...
        .then(response => {
          ...
          if (this.cases.length < 1) this.message = "No cases found!";
          this.isLoading = false;
        })
        .catch(e => {
          console.error(e);
