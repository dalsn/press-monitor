<template>
  <section>
    <div class="bg-hero pt-16 pb-8 md:pt-24">
      <div class="lg:mx-32 px-4 mb-16">
        <div class="mb-3">
          <h1 class="text-3xl font-bold font-transpurple mb-4">Contact</h1>
        ...
        <div class="md:grid grid-cols-2 mt-12">
          <div class="">
            ...
            <p class="text-justify">
              ...
              <a
                class="text-link"
                href="http://trustafrica.org"
                target="_blank"
                rel="noreferrer noopener"
                >TrustAfrica</a
              >
              to monitor corruption cases in Nigeria to ensure compliance,
              reduce delays, improve efficiency and achieve speedy conclusion of
              trials.
            </p>
          </div>
          <div class="mt-8 md:mt-0">
            <div class="w-full md:pl-12 mb-8">
              <p class="text-lg">Newsletter Signup</p>
