...
export default {
  ...
  computed: {
    // filterParams() {
    //   return this.$store.state.filtersMenu.selectedFilters;
    // },
    // ...mapGetters({
    //   darkMode: 'darkMode'
    // })
  ...
  watch: {
    // "$store.state.filtersMenu.count": {
    //   handler: function() {
    //     this.getCourtsLocations();
    //   }
    // },
    darkMode() {
      this.init();
