        ...
        >
          ...
          >
            ...
            <input
              id="search-text"
              type="text"
              class="search-text  h-full focus:outline-none pl-3  ml-5 w-full text-15"
          ...
          >
            ...
            <select
              class=" focus:outline-none bg-white w-full focus:shadow-outline focus:border focus:border-blue-700"
              id="search-dropdown"
            >
